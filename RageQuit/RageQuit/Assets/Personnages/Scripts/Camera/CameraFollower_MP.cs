...
public class CameraFollower_MP : NetworkBehaviour
{
    ...
    void Update()
    {
        ...
        {
            Cam.transform.rotation = Quaternion.Lerp(Cam.transform.rotation, cameraRotation, Time.deltaTime * RotationRecoveringSmooth); //camera orientation
            if (Cam.transform.rotation == cameraRotation)
